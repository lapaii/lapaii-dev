          ...
          <div className="m-5">
            ...
            <div className="m-5">
              ...
              <div className="md:text-2xl text-xl text-linkcol p-2.5">
                <a href="https://osu.ppy.sh/users/18784449" className="hover:decoration-4 hover:text-normalcol hover:underline w-1/3 md:px-5 px-2.5">osu!</a>•
                <a href="https://github.com/lapaii" className="hover:decoration-4 hover:text-normalcol hover:underline w-1/3 md:px-5 px-2.5">github</a>•
                <a href="https://twitch.tv/lapaiiosu" className="hover:decoration-4 hover:text-normalcol hover:underline w-1/3 md:px-5 px-2.5">twitch</a>
              </div>
            </div>
            <div className="m-5">
              <h1 className="md:text-2xl text-xl text-defaultcol">projects:</h1>
              <div className="md:text-2xl text-xl p-2.5 text-linkcol">
                <h1>soon!! &gt;w&lt;</h1>
              </div>
            </div>
          </div>
